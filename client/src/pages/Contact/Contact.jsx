                        ...
                        <form>
                          ...
                          " id="exampleFormControlTextarea13" rows="3" placeholder="Message"></textarea>
                            ...
                            <div className="form-group form-check text-center mb-6">
                                ...
                                <label className="form-check-label inline-block text-gray-800" htmlFor="exampleCheck87">Send
                                    me a copy of this
                                    message</label>
                            </div>
                                    ...
                                    <div className="shrink-0">
                                        <div
                                            ...
                                            <svg aria-hidden="true" focusable="false" data-prefix="fas"
                                                 data-icon="headset" className="w-5 text-white"
                                    ...
                                    <div className="shrink-0">
                                        <div
                                            ...
                                            <svg aria-hidden="true" focusable="false" data-prefix="fas"
                                                 ...
                                                 className="w-3 text-white" role="img"
                            ...
                            <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                <div className="flex align-start">
                                    ...
                                    <div className="grow ml-6">
                                        ...
                                        <p className="text-gray-500">noah.lhote56@gmail.com</p>
                                        <p className="text-gray-500">
                                            "developpeur" : "Noah Lhote"
                                        </p>
                                    </div>
                                </div>
                            </div>
