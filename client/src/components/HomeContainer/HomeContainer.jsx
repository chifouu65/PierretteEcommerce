            ...
            <div className="px-4 mx-auto max-w-screen-xl pb-8 lg:px-6">
                <div className="max-w-screen-md mb-8 lg:mb-16">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 ">
                        Pierrette Essentielle c'est quoi ?
                    </h2>
                ...
                <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <div>
                        <div
                            ...
                            <svg className="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 "
                        ...
                        <p className="text-gray-500 ">Plan it, create it, launch it. Collaborate
                    ...
                    <div>
                        ...
                        <p className="text-gray-500">Protect your organization, devices and stay
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 ">Auto-assign tasks, send Slack messages, and
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 ">Audit-proof software built for critical
                    ...
                    <div>
                        ...
                        <p className="text-gray-500">Craft beautiful, delightful experiences for
                    ...
                    <div>
                        ...
                        <p className="text-gray-500">Keep your company’s lights on with
