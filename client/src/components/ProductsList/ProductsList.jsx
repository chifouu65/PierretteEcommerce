            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                ...
                <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                    <div
                        ...
                        <div className="p-5">
                            <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="client/src/components#">Bonnie Green</a>
                            </h3>
                            ...
                            <ul className="flex space-x-4 sm:mt-0">
                                <li>
                                    <a href="client/src/components#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    ...
                    <div
                        ...
                        <div className="p-5">
                            <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="client/src/components#">Jese Leos</a>
                            </h3>
                    ...
                    <div
                        ...
                        <div className="p-5">
                            <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="client/src/components#">Michael Gough</a>
                            </h3>
                    ...
                    <div
                        ...
                        <div className="p-5">
                            <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="client/src/components#">Lana Byrd</a>
                            </h3>
